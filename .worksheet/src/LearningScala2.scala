object LearningScala2 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(141); 
  ...
  val number = 20;System.out.println("""number  : Int = """ + $show(number ));$skip(146); 
  number match {
  	case 1 => println("One")
  	case 2 => println("Two")
  ...
  do { println(x); x+=1 } while (x <= 10);$skip(154); val res$0 = 
   ...
   {val x = 10; x + 20};System.out.println("""res0: Int = """ + $show(res$0));$skip(82); 
	 ...
	 println({val x = 10; x + 20});$skip(33); 
	 
	 // EXERCISE
	 
	 var xx = 0;System.out.println("""xx  : Int = """ + $show(xx ));$skip(13); 
	 var yy = 1;System.out.println("""yy  : Int = """ + $show(yy ));$skip(14); 
	 var zz = 0;System.out.println("""zz  : Int = """ + $show(zz ));$skip(115); ;
